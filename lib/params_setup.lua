-- lib/params_setup.lua v0.22
-- CHANGELOG v0.22:
-- 1. FIX FATAL: Corrección de llamadas OSC fantasma hacia engine.set_global_physics.
-- 2. MAPEO: Corrección de los IDs de paneo del Nexus (55 a 58).
...
function Params.init(G)
    ...
    params:add{type = "option", id = "m8_tape_sat", name = "Nexus Tape Sat", options = {"CLEAN", "PUSHED", "CRUSHED"}, default = 1}
    ...
    for i = 1, 64 do
        ...
        params:add{type = "control", id = p_id, name = "Node " .. i .. " Level", controlspec = controlspec.new(-1.0, 1.0, 'lin', 0.01, 1.0)}
        params:hide(p_id)
