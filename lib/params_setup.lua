...
function Params.init(G)
    ...
    params:add{type = "option", id = "m1_range", name = "Range", options = {"HI", "LO"}, default = 1, action = function(x) engine.m1_range(x - 1) end}
    ...
    params:add{type = "option", id = "m4_type1", name = "Noise 1 Type", options = {"Pink", "White", "Crackle", "DigiRain", "Lorenz", "Grit"}, default = 1, action = function(x) engine.m4_type1(x - 1) end}
    params:add{type = "option", id = "m4_type2", name = "Noise 2 Type", options = {"Pink", "White", "Crackle", "DigiRain", "Lorenz", "Grit"}, default = 2, action = function(x) engine.m4_type2(x - 1) end}
