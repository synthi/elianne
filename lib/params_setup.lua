-- lib/params_setup.lua v0.28
-- CHANGELOG v0.28:
-- 1. FIX: thermal_drift renombrado a System Age (0.0 a 0.1, step 0.001).
-- 2. FIX: Opciones de rango de osciladores cambiadas a HI/LO.
-- 3. FIX: Añadidos m6_ping y m7_ping como triggers.
...
function Params.init(G)
    ...
    params:add{type = "option", id = "m1_range", name = "Range", options = {"HI", "LO"}, default = 1, action = function(x) engine.m1_range(x) end}
    ...
    params:add{type = "option", id = "m2_range", name = "Range", options = {"HI", "LO"}, default = 1, action = function(x) engine.m2_range(x) end}
    ...
    params:add{type = "option", id = "m3_range1", name = "Osc 1 Range", options = {"HI", "LO"}, default = 1, action = function(x) engine.m3_range1(x) end}
    ...
    params:add{type = "option", id = "m3_range2", name = "Osc 2 Range", options = {"HI", "LO"}, default = 1, action = function(x) engine.m3_range2(x) end}
