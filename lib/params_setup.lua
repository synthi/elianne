...
function Params.init(G)
    ...
    -- ==========================================
    -- Registramos los 64 nodos (Entradas y Salidas intercaladas) para que se guarden en el .pset
    ...
    for i = 1, 64 do
        ...
        -- Si es un nodo de entrada del Nexus (IDs 55, 56, 57, 58), añadimos Paneo
